...
def train_model(model, criterion, optimizer, scheduler, num_epochs=25):
    ...
    for epoch in range(1):
        ...
        for phase in range(1):
            ...
            model.train(True)  # Set model to evaluate mode
            ...
            for data in dataloader:
                ...
                print ('{} g_labels: {} p_labels: {}'.format(
                "val", labels.data, preds))
...
if __name__ == '__main__':
    ...
    """
    datas = perfect500k('/Users/EASON/Shaofu/orz_data/data', transform=transforms.Compose([
